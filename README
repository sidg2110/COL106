...
## Run
All the submissions are in Python. The test cases are not included in this repository. The I/O format for each assignment is mentioned in the corresponding `README`. The input should be in `input.txt` and the output will be written in `output.txt`. The script can be run using - 
```Shell
python <name_of_file>
```